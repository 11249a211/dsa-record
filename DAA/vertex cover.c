...
To design and analyze algorithms for solving the Vertex Cover problem, and to study exact and approximation techniques for finding a minimum vertex cover in a graph.
Algorithm 
