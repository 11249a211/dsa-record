Aim:
To implement Quicksort using a deterministic pivot selection strategy in order to achieve efficient sorting performance without the use of randomization.
